            ...
            <div key={num} className="flex flex-col items-center">
              <div
                className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-white font-semibold transition-all duration-300
                  ${step === num ? "bg-purple-600 shadow-[0_0_10px_rgba(128,0,255,0.6)]" : "bg-[#1b1b1f]"}`}
              >
                {num}
              </div>
        ...
        {step === 2 && (
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
              ...
              <div>
                <label className="block text-gray-400 text-sm mb-1 sm:mb-2">State *</label>
                <input
                  type="text"
            ...
            {/* Gender */}
            <div>
              <label className="block text-gray-400 text-sm mb-2 sm:mb-3">Gender *</label>
          ...
          <div className="mt-4 sm:mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="John"
                className="w-full mt-1 sm:mt-2 bg-[#111] border border-[#2A2A2A] text-gray-200 px-3 py-2 rounded-lg focus:border-purple-500"
              />
            </div>
